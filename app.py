...
st.set_page_config(
    page_title= "Customer Churn Prediction", layout= "wide"
)

# Add an image from URL
image_url = "https://www.neenopal.com/images/Understanding%20Customer%20Churn.png"
st.image(image_url, caption= 'Understanding the Leading Cause of Customer Churn', use_column_width=True)
...
- [GitHub](https://github.com/Chebet-Mercy)
- [LinkedIn](https://www.linkedin.com/in/mercy-chebet-/)
